...
describe('CssGenerator', () => {
  ...
  describe('pass-through format', () => {
    ...
    it('should preserve complex class names in pass-through', () => {
      ...
      expect(result.styles).toBe(
        'hover:bg-red-500 lg:text-xl focus:outline-none'
      );
    });
  });
  ...
  describe('CSS property conversion', () => {
    ...
    it('should convert spacing utilities correctly', () => {
      const testCases = [
        ...
        {
          class: 'px-6',
          expected: 'padding-left: 1.5rem; padding-right: 1.5rem',
        },
        {
          class: 'py-2',
          expected: 'padding-top: 0.5rem; padding-bottom: 0.5rem',
        },
  ...
  describe('edge cases', () => {
    ...
    it('should handle utilities with no CSS conversion', () => {
      ...
      const result = generator.generateCssFromUtilities(mockUtilities, {
        format: 'css',
      });
      expect(result.styles).toBe('');
    });
